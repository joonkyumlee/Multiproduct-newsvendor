...
%Input arguments: n=number of products, p_i=choice probability under full assortment, Nest_info=nest structure, N_nest=number of nests, Lambda=lambda for nested logit
