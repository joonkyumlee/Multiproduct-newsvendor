...
for z=Start_number:End_number
    ...
    Num_Customer=poissrnd(mu,[1,number_iteration]); % random number of customers; We actually preset this for the paper in Num_Customer.mat and used load('Num_Customer.mat')
