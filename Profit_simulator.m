...
Rand_number=rand(number_iteration,10000); % random number for customer choice; We actually preset this for the paper in Rand_numbers and used load('Rand_numbers.mat')
